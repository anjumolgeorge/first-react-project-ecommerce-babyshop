  ...
  return (
    <div style={{ backgroundColor: '#808080' }}>
      ...
      <img
        ...
        src="https://www.babycarestores.in/media/media/landingpageSlider/Web_Banner_Maternity.jpg"
        alt=""
      />

      <Container>
        <h1 style={{ textAlign: 'center', padding: '10px',color : '#FBFCFC',fontFamily: 'cursive',fontSize:'6rem' }}>BabyCare Products</h1>
        <hr />
